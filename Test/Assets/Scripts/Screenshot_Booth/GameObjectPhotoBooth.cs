...
public class PhotoObjects
{
    ...
    public Vector3 pictureOffset;
}

public class GameObjectPhotoBooth : MonoBehaviour
{
    ...
    [SerializeField] PhotoObjects[] _arrayOfPhotoObjects; // add all units to have pictures taken here:
    ...
    [Space(10)]
    [SerializeField] Material _noShadowMaterial;
    ...
    private IEnumerator CaptureScreenshotsWithDelay()
    {
        ...
        {
            GameObject _currentObject = Instantiate(_arrayOfPhotoObjects[i].gO, new Vector3(0, 0, 0), Quaternion.identity, _parentForInstantiatedObjects.transform);
            _currentObject.SetActive(true);

            yield return TakePicture(_currentObject, i, _arrayOfPhotoObjects[i].pictureOffset);
